namespace AtomicTorch.CBND.CoreMod.Items.Weapons.MobWeapons
{
    ...
    public class ItemWeaponMobSMG : ProtoItemMobNPCWeaponRanged
    {
        ...
        public override ushort VirtualAmmoCapacity => 24;

        public override double DamageApplyDelay => 0.1;

        public override double AmmoReloadDuration => 2.0; // lowerpublic override double CharacterAnimationAimingRecoilDuration => 0.3;
