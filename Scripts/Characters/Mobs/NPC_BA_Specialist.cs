namespace AtomicTorch.CBND.CoreMod.Characters.Mobs
{
    ...
    public class MobNPC_BA_Specialist : ProtoCharacterNPCBA
    {
		...
		public override double StatHealthRegenerationPerSecond => 15.0 / 20.0; // Default: 10/60 10 health points per minute
		
        public override bool IsAvailableInCompletionist => false;

        public override double RetreatDistance => 7;

        public override double EnemyToCloseDistance => 7;
