namespace AtomicTorch.CBND.CoreMod.StaticObjects.Misc
{
    ...
    public class ObjectSecretLocationTeleport : ProtoObjectSecretLocationTeleport
    {
        ...
        public ObjectSecretLocationTeleport()
        {
            var texturePath = $"StaticObjects/Misc/{nameof(ObjectSecretLocationTeleport)}";
        ...
        public override string Name => "Secret location teleport";
