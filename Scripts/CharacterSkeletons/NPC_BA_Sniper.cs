namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class NPC_BA_Sniper : ProtoCharacterSkeletonNPC
    {
        ...
        public override SkeletonResource SkeletonResourceBack { get; }
            = new SkeletonResource("NPC_BA_Sniper/MaleBack");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("NPC_BA_Sniper/MaleFront");
        ...
        {
            shadowRenderer.PositionOffset = (0, -0.05 * scaleMultiplier);
