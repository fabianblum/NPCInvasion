namespace AtomicTorch.CBND.CoreMod.CharacterSkeletons
{
    ...
    public class NPC_BA_Striker : ProtoCharacterSkeletonNPC
    {
        public override double DefaultMoveSpeed => 3.2;
        ...
        public override SkeletonResource SkeletonResourceBack { get; }
            = new SkeletonResource("NPC_BA_Striker/MaleBack");

        public override SkeletonResource SkeletonResourceFront { get; }
            = new SkeletonResource("NPC_BA_Striker/MaleFront");
